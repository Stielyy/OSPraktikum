...
unsigned long var;
var = atomic_fetch_add(&curent, 1 ); 
if(var > 100000000) break;

unsigned long var2;
int iterations = collatz(var);
var2 = atomic_fetch_add(&localcolsum, iterations);
...
atomic_fetch_add(&colsum, localcolsum);
